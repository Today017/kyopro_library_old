...
struct rolling_hash {
	...
	tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long, unsigned long long> hash(int l, int r) {
		...
		return make_tuple(val1.value, val2.value, val3.value, val4.value, val5.value);
	}
};